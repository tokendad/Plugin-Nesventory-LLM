...
<input type="button" value="To Find on this page, Click Here, Enter the item number or part of the product name.."
onclick="show();">
...
var find_root_node = "mycontent"; // Leave as null to search entire doc or put id of div to search (ex: 'content'). Ver 5.0a - 7/18/2014
...
function create_div(dleft, dtop, dwidth, dheight)
{
	...
	document.write('<input style="font-size:1em" type="button" value="To Find on this page, Click Here, Enter the item number or part of the product name.."'
